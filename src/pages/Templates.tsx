    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container max-w-screen-2xl mx-auto px-4 sm:px-6 pb-12">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Choose a pre-made template or <Link to="/" className="text-sky-600 hover:text-sky-800">create your own custom festival checklist</Link></p>
        </div>
