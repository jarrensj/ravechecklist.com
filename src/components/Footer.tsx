...
const Footer: React.FC = () => {
  return (
    <footer className="bg-background py-4 mt-8 border-t border-border transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-4 text-muted-foreground">
              <a href="mailto:omakasemoney@gmail.com" className="flex items-center gap-1 hover:text-primary transition-colors">
                <Mail className="h-4 w-4" />
                <span className="text-xs">Contact</span>
              </a>
              <a href="https://discord.gg/omakase" className="flex items-center gap-1 hover:text-primary transition-colors">
